...
pub fn router(state: AppState) -> Router {
    ...
    let admin_routes = Router::new()
        ...
        .route("/api/admin/scraper/health", get(admin::scraper_health))
        .route("/api/admin/email-stats", get(admin::email_stats))
        .route("/api/admin/data-quality", get(admin::data_quality))
        .route("/api/admin/debug/notifications", get(admin::debug_notifications))
        .route("/api/admin/data/judgments/bulk-delete", post(admin::bulk_delete_judgments))
        .route("/api/admin/data/sittings/bulk-delete", post(admin::bulk_delete_sittings))
