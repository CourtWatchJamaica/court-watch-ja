    ...
    >
      ...
      <CardHeader className="pb-2 pt-4 px-4">
        <div className="flex items-start justify-between gap-3">
          <h3 className="min-w-0 flex-1 font-semibold text-foreground/80 text-[13px] leading-snug group-hover:text-foreground transition-colors line-clamp-2">
            {judgment.title || judgment.case_number}
          </h3>
          <div className="flex items-center gap-1.5 shrink-0 min-w-0">
            <span className="shrink-0 font-mono text-[10px] text-primary/70 bg-primary/[0.08] border border-primary/[0.18] px-1.5 py-0.5 rounded-md break-all whitespace-normal leading-tight min-w-0">
              {judgment.case_number}
            </span>
            {onTrack && (
              isTracked ? (
