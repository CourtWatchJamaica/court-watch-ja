  ...
  return (
    <div className="min-h-screen bg-[#080810] text-white">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        <div className="mb-10">
          <h1 className="font-heading text-3xl sm:text-4xl font-semibold tracking-tight">Terms of Service</h1>
        ...
        <div className="space-y-8 text-white/65 leading-relaxed text-sm">
          ...
          <section>
            <h2 className="font-heading text-lg font-semibold text-white mb-3">1. Acceptance of Terms</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-lg font-semibold text-white mb-3">2. Not Legal Advice</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-lg font-semibold text-white mb-3">3. Accuracy of Information</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-lg font-semibold text-white mb-3">4. Use of the Service</h2>
          ...
          <section>
            <h2 className="font-heading text-lg font-semibold text-white mb-3">5. Accounts</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-lg font-semibold text-white mb-3">6. Notifications</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-lg font-semibold text-white mb-3">7. Intellectual Property</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-lg font-semibold text-white mb-3">8. Limitation of Liability</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-lg font-semibold text-white mb-3">9. Changes to Terms</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-lg font-semibold text-white mb-3">10. Governing Law</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-lg font-semibold text-white mb-3">11. Contact</h2>
            <p>
